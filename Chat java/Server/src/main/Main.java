...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmdStart.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        cmdStop.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lbStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        run = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    registry.bind("messenger", new RemoteMethod());
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        try {
            int c = JOptionPane.showConfirmDialog(this, "Are you sure to want start the server?", "Start Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (c == JOptionPane.YES_OPTION) {
                startServer();
            }
        } catch (Exception e) {
